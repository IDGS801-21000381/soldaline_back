...
public partial class SoldalineBdContext : DbContext
{
    ...
    public virtual DbSet<RecetasProteccione> RecetasProtecciones { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__carrito__3213E83FB57AD3BC");
        ...
        {
            entity.HasKey(e => e.ClienteId).HasName("PK__ClienteP__71ABD0A72791F063");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__compra__3213E83F58861A21");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__detalleP__3213E83F3C5C3DF8");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__detallec__3213E83F98911924");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__detallep__3213E83F900003E2");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__detalles__3213E83FFAC70A38");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__detallev__3213E83F7B3EF903");
        ...
        {
            entity.HasKey(e => e.EmpresaId).HasName("PK__Empresa__7B9F213653A84379");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Estimaci__3214EC0757690E56");
            ...
            entity.HasOne(d => d.Fabricacion).WithMany(p => p.EstimacionProduccions)
                .HasForeignKey(d => d.FabricacionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Estimacio__Fabri__1BC821DD");
        });

        modelBuilder.Entity<Fabricacion>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__fabricac__3213E83F4B602C29");
        ...
        {
            entity.HasKey(e => e.HistorialId).HasName("PK__Historia__975206EFE5B6D9D3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Historia__3213E83F2D5890AD");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__inventar__3213E83F14642954");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__inventar__3213E83FD914ACFF");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__material__3213E83F00E8DE8A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__material__3213E83F4874B4A0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__merma__3213E83F9D1D8D1F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__pedido__3213E83FEE5A62C1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__producci__3213E83F071CE4EB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__producto__3213E83F153CEC1D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__proveedo__3213E83FBAECC4D0");
        ...
        {
            entity.HasKey(e => e.ProyectoId).HasName("PK__Proyecto__CF241D45A7AD6AF5");
        ...
        modelBuilder.Entity<RecetasProteccione>(entity =>
        {
            entity.HasKey(e => e.IdReceta).HasName("PK__RecetasP__7D03FC81F0DDA3EC");
            ...
            entity.Property(e => e.IdFabricacion).HasColumnName("idFabricacion");
            entity.Property(e => e.Material)
                .HasMaxLength(100)
                .HasColumnName("material");
            entity.Property(e => e.TipoProteccion)
                .HasMaxLength(50)
                .HasColumnName("tipoProteccion");
            entity.Property(e => e.Unidad)
                .HasMaxLength(20)
                .HasColumnName("unidad");

            entity.HasOne(d => d.IdFabricacionNavigation).WithMany(p => p.RecetasProtecciones)
                .HasForeignKey(d => d.IdFabricacion)
                .HasConstraintName("FK_RecetasProtecciones_Fabricacion");
        });

        modelBuilder.Entity<SegmentoCliente>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Segmento__3213E83FD87FCDFA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__solicitu__3213E83F9F6507B6");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__usuario__3213E83FCE8AB03A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__UsuarioS__3213E83F9ADC07C7");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__venta__3213E83F9CBA4F6F");
