...
namespace soldaline_back.Controllers
{
    ...
    public class ProveedorController : Controller
    {
        ...
        {
            var proveedores = await _context.Proveedors.ToListAsync(); // Obtiene todos los proveedores
            ...
            // Mapear los proveedores a un DTO si es necesario
            var proveedoresResponse = proveedores.Select(p => new ProveedorResponseDTO
            {
                Id = p.Id,
