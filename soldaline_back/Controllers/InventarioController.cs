...
namespace soldaline_back.Controllers
{
    ...
    public class InventarioController : Controller
    {
        ...
        [HttpGet("producto/")]
        public async Task<IActionResult> GetProductoInventario()
        {
            var inventarioProducto = await _context.InventarioProductos
                .Include(ip => ip.Fabricacion)
                .Include(ip => ip.Produccion)
                .Select(ip => new
                {
                    ip.Id,
                    ip.Cantidad,
                    ...
                    {
                        ip.Fabricacion.Id,
                        ip.Fabricacion.NombreProducto,
                        ip.Fabricacion.ImagenProducto
                    },
                    Produccion = new
                    {
                        ip.Produccion.Id,
